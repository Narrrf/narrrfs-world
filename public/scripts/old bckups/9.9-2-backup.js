...
// Preload images for block types
const pieceImageMap = {
  0: null, // empty
  1: 'block_T.png',
  2: 'block_O.png',
...
for (let i = 1; i <= 8; i++) {
  const img = new Image();
  img.src = `http://localhost/public/img/tetris/${pieceImageMap[i]}`;
  blockImages[i] = img;
}

 // index 8 → coral color for Blocks with png in img/tetris
...
function renderNextBlock(shape) {
  ...
  // 💣 Bomb detection & warning toggle — ✅ now correctly placed
